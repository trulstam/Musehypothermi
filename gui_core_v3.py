...
class CalibrationTab(QWidget):
    """Calibration UI is disabled in the recovery branch."""
    ...
    def __init__(self, main_window: "MainWindow"):
        ...
        layout = QVBoxLayout()
        notice = QLabel("Calibration disabled in recovery branch")
    ...
    def _add_calibration_point(self):
        self.main_window.log("Calibration disabled in recovery branch", "warning")

    def _commit_calibration(self):
        self.main_window.log("Calibration disabled in recovery branch", "warning")

    def update_table(self, payload: Dict[str, Any]):
        # No-op: calibration support removed
        return

    def update_raw_values(self, plate_raw: float, plate_cal: float, rectal_raw: float, rectal_cal: float):
        # No-op: calibration support removed
        return
